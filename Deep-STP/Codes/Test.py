...
data = np.array(pd.read_csv('/content/drive/MyDrive/Independent_hasan.csv')) #testing set
    
X1 = data[0:54, 1:] #54 is the number of positive samples in testing set, '1' is the label of positive sample
Y1 = data[0:54, 0] #'0' is the label of negative sample
X2 = data[54:, 1:]
Y2 = data[54:, 0]
...
model_name = ('/content/drive/MyDrive/hasan/Toxin500_model/saved_model.pb') #load model generated by Deep-STP.ipynb
model_back = load_model(model_name, 
                        custom_objects={'precision': precision,'recall':recall,'f1':f1,'TP':TP,'FN':FN,'TN':TN,'FP':FP})
# model = load_model('/content/drive/MyDrive/hasan/Toxin500_model/saved_model.pb')
